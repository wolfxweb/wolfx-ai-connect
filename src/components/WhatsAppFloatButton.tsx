...
const WhatsAppFloatButton = () => {
  ...
  return (
    <a
      ...
      className="whatsapp-float-button fixed bottom-6 right-6 z-50 group"
    ...
    >
      <div className="relative">
        ...
        {/* Botão principal */}
        <div className="relative w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-2xl hover:shadow-green-500/50 transition-all duration-300 transform hover:scale-110 group-hover:rotate-12 cursor-pointer">
          <svg
